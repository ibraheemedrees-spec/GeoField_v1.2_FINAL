        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    Text { text: licenseManager.shortHardwareId; color: "#ff9800"; font.pixelSize: 16; font.bold: true; font.family: "monospace" }
                }
            }
            ...
            TextField {
                ...
                color: "#fff"; font.family: "monospace"; horizontalAlignment: Text.AlignHCenter
        ...
        StackLayout {
                                ...
                                delegate: Rectangle {
                                    ...
                                    RowLayout {
                                        ...
                                        Text {
                                            ...
                                            color: "#9e9e9e"; font.family: "monospace"; Layout.fillWidth: true
                                        }
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            Text {
                                ...
                                color: "#00e5ff"; font.family: "monospace"; font.pixelSize: 15; font.bold: true
                            }
                            Text {
                                text: gnssDevice.isConnected && gnssDevice.currentPosition.valid
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            Text {
                                ...
                                color: "#fff"; font.pixelSize: 22; font.family: "monospace"; Layout.alignment: Qt.AlignHCenter
                            }
                            Text {
                            ...
                            Text {
                                ...
                                color: "#00e5ff"; font.pixelSize: 16; font.family: "monospace"; Layout.alignment: Qt.AlignHCenter
                            }
                            Text {
                    ...
                    ListView {
                        ...
                        delegate: Rectangle {
                            ...
                            Text {
                                ...
                                color: "#ccc"; font.pixelSize: 12; font.family: "monospace"
                            }
                        }
                    }
                    ...
                    ListView {
                        ...
                        delegate: Rectangle {
                            ...
                            Text {
                                ...
                                color: "#ccc"; font.family: "monospace"; font.pixelSize: 12
                            }
                        }
                    }
                    Button { text: qsTr("← Home"); onClicked: currentPage = 0 }
            ...
            Item {
                ColumnLayout {
                    ...
                    Text { id: cogoResult; color: "#00e5ff"; font.pixelSize: 16; font.family: "monospace" }
                    Button { text: qsTr("← Home"); onClicked: currentPage = 0 }
                }
            }
        }
