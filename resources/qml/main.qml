...
Window {
    ...
    component SettingsRow: Rectangle {
        ...
        Column {
            ...
            spacing: 2
            Text { text: title; color: ink; font.pixelSize: 15; font.bold: true }
            ...
            Column {
                ...
                Rectangle {
                    ...
                    Text {
                        ...
                        color: ink; font.bold: true; font.pixelSize: 13
                    }
                }
            }
...
// ================= JOB =================
            ...
            Column {
                ...
                Column {
                    ...
                    width: parent.width
                    spacing: 6
                    Text { text: "Settings"; color: ink; font.pixelSize: 16; font.bold: true }
                ...
                Column {
                    ...
                    width: parent.width
                    spacing: 6
                    Text { text: "Receiver"; color: ink; font.pixelSize: 16; font.bold: true }
                ...
                Column {
                    ...
                    width: parent.width
                    spacing: 6
                    Text { text: "Antenna"; color: ink; font.pixelSize: 16; font.bold: true }
                ...
                Column {
                    ...
                    width: parent.width
                    spacing: 6
                    Text { text: "Corrections · NTRIP"; color: ink; font.pixelSize: 16; font.bold: true }
                ...
                Column {
                    ...
                    width: parent.width
                    spacing: 6
                    Text { text: "Rover quality gates"; color: ink; font.pixelSize: 16; font.bold: true }
                ...
                Column {
                    ...
                    width: parent.width
                    spacing: 6
                    Text { text: "Geoid"; color: ink; font.pixelSize: 16; font.bold: true }
                ...
                Column {
                    ...
                    width: parent.width
                    spacing: 6
                    Text { text: "Diagnostics entry"; color: ink; font.pixelSize: 16; font.bold: true }
            ...
            Column {
                ...
                width: parent.width - 28
                spacing: 8
                Text { text: "Receiver connection"; color: ink; font.pixelSize: 16; font.bold: true }
                ...
                Rectangle {
                    ...
                    Column {
                        ...
                        anchors.topMargin: 8
                        spacing: 4
                        Text { text: "Bluetooth"; color: ink; font.bold: true; font.pixelSize: 13 }
                        InfoRow {
                            k: "Adapter"
                    ...
                    Rectangle {
                        ...
                        Column {
                            ...
                            Text {
                                ...
                                color: ink; font.bold: true; font.pixelSize: 12
                            }
                            Text {
            ...
            Column {
                ...
                width: parent.width - 28
                spacing: 8
                Text { text: "Receiver setup"; color: ink; font.pixelSize: 16; font.bold: true }
            ...
            Column {
                ...
                width: parent.width - 28
                spacing: 8
                Text { text: "Map (full)"; color: ink; font.pixelSize: 16; font.bold: true }
                Text {
                    width: parent.width; wrapMode: Text.WordWrap; color: muted; font.pixelSize: 12
            ...
            Column {
                ...
                Column {
                    ...
                    width: parent.width
                    spacing: 6
                    Text { text: "Checklist"; color: ink; font.pixelSize: 14; font.bold: true }
            ...
            Column {
                ...
                width: parent.width - 28
                spacing: 8
                Text { text: "Diagnostics"; color: ink; font.pixelSize: 16; font.bold: true }
                Text {
