    ...
    Rectangle {
        ...
        Row {
            ...
            Item {
                ...
                Rectangle { anchors.centerIn: parent; width: 28; height: 28; radius: 28/2; color: "transparent"; border.color: "#00bcd4"; border.width: 3 }
                Rectangle { anchors.centerIn: parent; width: 28*0.7; height: 28*0.7; radius: width/2; color: "transparent"; border.color: "#00e5ff"; border.width: 2 }
                Rectangle { anchors.centerIn: parent; width: 28*0.2; height: 28*0.2; radius: width/2; color: "#00bcd4" }
            }
    ...
    Flickable {
        ...
        Column {
            ...
            Item {
                ...
                Rectangle { anchors.centerIn: parent; width: 100; height: 100; radius: 100/2; color: "transparent"; border.color: "#00bcd4"; border.width: 3 }
                Rectangle { anchors.centerIn: parent; width: 100*0.7; height: 100*0.7; radius: width/2; color: "transparent"; border.color: "#00e5ff"; border.width: 2 }
                Rectangle { anchors.centerIn: parent; width: 100*0.2; height: 100*0.2; radius: width/2; color: "#00bcd4" }
            }
            ...
            Item {
                ...
                Column {
                    ...
                    Text {
                        color: "#cfd8dc"
                        text: {
                            try { return "GPS: " + (gnssDevice.useGps ? "ON" : "OFF") + "  (tap)" }
                            catch (e) { return "GPS" }
                        }
                        MouseArea {
                            anchors.fill: parent
                            onClicked: { try { gnssDevice.useGps = !gnssDevice.useGps } catch (e) {} }
                        }
                    }
                    Text {
                        color: "#cfd8dc"
                        text: {
                            try { return "GLONASS: " + (gnssDevice.useGlonass ? "ON" : "OFF") + "  (tap)" }
                            catch (e) { return "GLONASS" }
                        }
                        MouseArea {
                            anchors.fill: parent
                            onClicked: { try { gnssDevice.useGlonass = !gnssDevice.useGlonass } catch (e) {} }
                        }
                    }
                    Text {
                        color: "#cfd8dc"
                        text: {
                            try { return "Galileo: " + (gnssDevice.useGalileo ? "ON" : "OFF") + "  (tap)" }
                            catch (e) { return "Galileo" }
                        }
                        MouseArea {
                            anchors.fill: parent
                            onClicked: { try { gnssDevice.useGalileo = !gnssDevice.useGalileo } catch (e) {} }
                        }
                    }
                    Text {
                        color: "#cfd8dc"
                        text: {
                            try { return "BeiDou: " + (gnssDevice.useBeidou ? "ON" : "OFF") + "  (tap)" }
                            catch (e) { return "BeiDou" }
                        }
                        MouseArea {
                            anchors.fill: parent
                            onClicked: { try { gnssDevice.useBeidou = !gnssDevice.useBeidou } catch (e) {} }
                        }
                    }
                    Text {
                        color: "#cfd8dc"
                        text: {
                            try { return "QZSS: " + (gnssDevice.useQzss ? "ON" : "OFF") + "  (tap)" }
                            catch (e) { return "QZSS" }
                        }
                        MouseArea {
                            anchors.fill: parent
                            onClicked: { try { gnssDevice.useQzss = !gnssDevice.useQzss } catch (e) {} }
                        }
                    }
                    ...
                    Text {
                        color: "#cfd8dc"
                        text: {
                            try { return ntripSettings.enabled ? "NTRIP: ON (tap)" : "NTRIP: OFF (tap)" }
                            catch (e) { return "NTRIP" }
                        }
                        MouseArea {
                            anchors.fill: parent
                            onClicked: { try { ntripSettings.enabled = !ntripSettings.enabled } catch (e) {} }
                        }
                    }
            ...
            Item {
                ...
                Column {
                    ...
                    Item {
                width: 64; height: 64; anchors.horizontalCenter: parent.horizontalCenter
                Rectangle { anchors.centerIn: parent; width: 64; height: 64; radius: 64/2; color: "transparent"; border.color: "#00bcd4"; border.width: 3 }
                Rectangle { anchors.centerIn: parent; width: 64*0.7; height: 64*0.7; radius: width/2; color: "transparent"; border.color: "#00e5ff"; border.width: 2 }
                Rectangle { anchors.centerIn: parent; width: 64*0.2; height: 64*0.2; radius: width/2; color: "#00bcd4" }
            }
