    ...
    component BottomTab: Item {
        ...
        Column {
            ...
            Text {
                ...
                text: glyph
                color: parent.parent.sel ? brand : "#9e9e9e"
                font.pixelSize: 14
                font.bold: true
            }
            Text {
        ...
        Column {
            ...
            Column {
                ...
                Text {
                    ...
                    color: brand
                    text: safeProject() !== ""
                          ? ("Active: " + safeProject() + " · " + safePointCount() + " points (saved)")
                          : "No active job"
                }
            }
            ...
            Column {
                ...
                Rectangle {
                    ...
                    Column {
                        ...
                        Text {
                            anchors.horizontalCenter: parent.horizontalCenter
                            text: {
                                try { return mapEngine.mapStatus } catch(e) { return "Map engine ready" }
                            }
                            color: muted
                            font.pixelSize: 11
                        }
                ...
                SecondaryBtn {
                    label: "Open default MBTiles"
                    onTapped: { try { mapEngine.openDefaultMbTiles() } catch(e) {} }
                }
            }
            ...
            Column {
                ...
                InfoRow {
                    k: "State"
                    v: { try { return gnssManager.connectionState } catch(e) { return "—" } }
                }
                InfoRow {
                    k: "BT Permission"
                ...
                FieldInput {
                    id: ct
                    placeholder: "Serial / Bluetooth / BLE"
                    Component.onCompleted: {
                        try { text = gnssManager.connectionType } catch(e) {}
                    }
                }
                FieldInput {
                    id: cp
                    placeholder: "Port or BT address"
                    Component.onCompleted: {
                        try { text = gnssManager.portName } catch(e) {}
                    }
                }
                FieldInput {
                    id: cb
                    placeholder: "Baud"
                    Component.onCompleted: {
                        try { text = "" + gnssManager.baudRate } catch(e) {}
                    }
                }
                PrimaryBtn {
            ...
            Column {
                ...
                InfoRow {
                    k: "Job"
                    v: safeProject() !== "" ? safeProject() : "Open job first"
            ...
            Column {
                ...
                InfoRow {
                    k: "Diagnostics"
                    v: {
                        try { return transportDiagnostics.statusSummary } catch(e) { return "—" }
                    }
                }
        ...
        Rectangle {
            ...
            Column {
                ...
                Text {
                    ...
                    wrapMode: Text.WordWrap
                    text: safeProject() !== ""
                          ? ("Job saved: " + safeProject() + " (" + safePointCount() + " pts)")
                          : "No active job"
                    color: muted
                    font.pixelSize: 12
                }
