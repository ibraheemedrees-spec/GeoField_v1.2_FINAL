...
int main(int argc, char *argv[])
{
    ...
    QObject::connect(&gnssManager, &GnssManager::positionUpdated, &transportDiagnostics,
                     [&]() {
                         transportDiagnostics.noteSolutionQuality(
                             gnssManager.quality(),
                             gnssManager.satellites(),
    ...
    QObject::connect(&ntripClient, &NtripClient::connectionChanged, &transportDiagnostics,
                     [&]() { transportDiagnostics.setNtripConnected(ntripClient.isConnected()); });
