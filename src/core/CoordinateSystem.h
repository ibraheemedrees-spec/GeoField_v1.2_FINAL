...
public:
    ...
    // Returns {north,east,elev,valid} – QVariantMap is QML-safe on Android
    Q_INVOKABLE QVariantMap geographicToProjected(double latitude, double longitude, double altitude = 0.0) const;
